...
> Counts: Arch `pacman.txt` 193 / CachyOS 205 · Arch `aur.txt` 33 / CachyOS 28.
...
| -------------------- | ------------------------------------------------------------------------------------------------------------- |
| `extension-manager`  | Moved to `pacman.txt` — available from the repos.                                                             |
| `proton-vpn-gtk-app` | Moved to `pacman.txt`.                                                                                        |
